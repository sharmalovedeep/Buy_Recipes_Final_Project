...
namespace Buy_Recipes_Final_Project.Areas.Identity.Pages.Account
{
    ...
    public class RegisterAdminModel : PageModel
    {
        ...
        public RegisterAdminModel(
            ...
            Buy_Recipes_IdentityContext _context
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var roleExistsResult = await _roleManager.RoleExistsAsync("super_user");
                    if (!roleExistsResult)
                    {
                        var roleReuslt = await _roleManager.CreateAsync(new IdentityRole("super_user"));
